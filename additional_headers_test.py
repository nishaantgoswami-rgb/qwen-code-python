#!/usr/bin/env python3
"""
Test with additional DashScope headers
"""
...
async def test_with_additional_headers():
    """Test with additional DashScope headers."""
    print("Testing with additional DashScope headers...")
    ...
    # Use the DashScope compatible API endpoint
    ...
    headers = {
        ...
        "X-DashScope-UserAgent": "Qwen-Code-CLI/1.0",  # Add user agent
...
if __name__ == "__main__":
    asyncio.run(test_with_additional_headers())