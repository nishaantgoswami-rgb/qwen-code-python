...
class KeyboardHandler:
    ...
    def __init__(self):
        self.commands = ["/help", "/clear", "/stats", "exit", "quit"]
            ...
            if msvcrt.kbhit():
                ...
                if key == '\r':  # Enter key
                    ...
                    if len(user_input) > 0:
                        ...
                        console.print("\b \b", end="", flush=True)  # Erase last character
                elif key == '\x03':  # Ctrl+C
                    raise KeyboardInterrupt
                elif key == '/':  # Forward slash
                    user_input += key
                    console.print(key, end="", flush=True)
                    ...
                    if user_input.startswith('/'):
                        ...
                        if completed_command and completed_command != user_input:
                            ...
                            console.print(user_input, end="", flush=True)
                else:
                    user_input += key
                    console.print(key, end="", flush=True)
    ...
    def _auto_complete_command(self, partial_input: str) -> str:
        ...
        if len(matches) == 1:
            ...
            if prefix and len(prefix) > len(partial_input):
                ...
                console.print(f"[bold green]You[/bold green]: {partial_input}", end="", flush=True)
