#!/usr/bin/env python3
"""
Debug script for Qwen OAuth implementation without user input
"""
...
if __name__ == "__main__":
    ...
    if device_response and verifier:
        ...
        print("After authorizing, run the token polling debug function manually.")
        # We'll just show what the next step would be
        print("\nTo test token polling, run:")
        print(f"debug_token_polling('{device_response['device_code']}', '{verifier}')")